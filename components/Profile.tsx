      ...
      <div className={`w-full bg-black border-2 ${cardColor} p-6 shadow-[0_0_30px_rgba(0,0,0,0.5)] relative overflow-hidden transition-all duration-500`}>
        ...
        <div className="flex justify-between items-start border-b border-gray-800 pb-4 mb-6 relative z-10">
          ...
          <div className="text-right">
             <div className="text-[10px] text-gray-500 mb-1 uppercase">Уровень допуска</div>
        ...
        <div className="flex flex-col md:flex-row gap-8 relative z-10">
           <div className="shrink-0 flex flex-col items-center gap-2">
              <div className="w-32 h-40 bg-gray-900 border border-gray-700 flex items-center justify-center relative overflow-hidden group cursor-pointer" onClick={handleAvatarClick}>
                 {user.avatar_url ? <img src={user.avatar_url} alt="Profile" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all" /> : <User size={64} className="text-gray-700" />}
           ...
           <div className="flex-1 space-y-4">
              <div>
                <label className="text-[10px] text-gray-500 uppercase tracking-wider flex items-center gap-1"><User size={10} /> Имя</label>
        ...
        <div className="mt-6 pt-4 border-t border-gray-800 flex items-center justify-between">
           ...
           <div className="ml-4 text-[9px] text-gray-600 font-mono">СРОК: БЕССРОЧНО</div>
        </div>
      </div>
