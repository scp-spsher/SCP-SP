...
const Guide: React.FC<GuideProps> = ({ currentClearance }) => {
  ...
  const Redact = ({ text, minLevel, placeholder = "[ДАННЫЕ УДАЛЕНЫ]" }: { text: string, minLevel: number, placeholder?: string }) => {
    ...
    return <span className="bg-white/10 text-gray-600 px-1 font-mono select-none" title="Доступ ограничен">{placeholder}</span>;
  };
        ...
        <div className="max-w-4xl mx-auto bg-white/5 border border-gray-800 p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <header className="border-b-2 border-scp-text pb-8 mb-10 text-center relative z-10">
            ...
            <div className="flex items-center justify-center gap-4 text-xs text-gray-500 uppercase tracking-widest font-mono">
               ...
               <span>Статус: <Redact text="Рассекречено" minLevel={2} placeholder="Частично ограничено" /></span>
            </div>
          </header>
          ...
          <article className="space-y-8 text-gray-300 font-serif leading-relaxed text-lg relative z-10">
            ...
            <div className="py-12 flex flex-col items-center border-y border-gray-800 my-10">
               ...
               <p className="text-xs text-gray-500 mt-2 font-mono">— <Redact text="Администратор" minLevel={2} /></p>
            </div>

            <section className="space-y-4">
              <h2 className="text-2xl font-black text-white uppercase border-l-4 border-scp-accent pl-4 font-mono">Описание цели</h2>
              <p>
                Невидимый и вездесущий, Фонд SCP находится вне пределов чьей-либо юрисдикции. Он наделён соответствующими полномочиями всех основных мировых правительств и имеет задачу сдерживания объектов и явлений, которые ставят под угрозу естественность и нормальность этого мира. Подобные аномалии представляют собой значительную угрозу для <Redact text="глобальной безопасности" minLevel={2} /> и могут нести как физическую, так и психологическую опасность.
              </p>
              <p>
                Фонд действует, чтобы нормы так и оставались нормами, чтобы население Земли могло и дальше жить обычной жизнью, не боясь и не подвергая сомнению своё восприятие окружающего мира, чтобы человечество было защищено от <Redact text="различных внеземных угроз, а также угроз из других измерений и вселенных" minLevel={2} />.
              </p>
            </section>
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    Фонд захватывает аномалии, не допуская их попадания в руки гражданских лиц (тем самым обеспечивая их безопасность) или <Redact text="враждебных организаций" minLevel={2} /> (тем самым обеспечивая безопасность от них). Это достигается путём ведения <Redact text="глобальной слежки" minLevel={2} /> и быстрого реагирования на любое проявления аномальной активности.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    Фонд содержит аномалии, чтобы не допускать распространения их влияния. Это достигается путём их перемещения, маскировки или <Redact text="демонтажа" minLevel={3} />, а также подавлением или недопущением распространения информации об аномалиях среди широкой общественности.
                  </p>
                </div>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm">С целью выполнения основных задач Фонд регулярно проводит множество тайных операций по всему миру.</p>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm">
                Фонд действует в режиме строжайшей секретности. Каждый из его сотрудников обладает одним из уровней допуска, который позволяет ему получать доступ только к необходимой для выполнения его обязанностей информации. Персонал Фонда, уличённый в нарушении протоколов секретности, идентифицируется, задерживается и подвергается дисциплинарным мерам, зависящим от серьёзности нарушения.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm">
                От персонала Фонда требуется проявлять осторожность при взаимодействии с членами подобных группировок, сотрудничество с ними без предварительного согласования с руководством может послужить причиной применения дисциплинарных мер, вплоть до <Redact text="устранения" minLevel={3} placeholder="административного наказания" />.
              </p>
            </section>
          </article>
